...
exports.normalizeBengaliNumerals = normalizeBengaliNumerals;
exports.normalizeBdMobile = normalizeBdMobile;
exports.isValidBdMobile = isValidBdMobile;
 ...
 */
function normalizeBengaliNumerals(str) {
    if (!str)
        return '';
 ...
 */
function normalizeBdMobile(str) {
    if (!str)
        return '';
 ...
 */
function isValidBdMobile(str) {
    const norm = normalizeBdMobile(str);
    return /^01[3-9]\d{8}$/.test(norm);
}
//# sourceMappingURL=bengali.js.map