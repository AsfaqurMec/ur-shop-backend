...
export declare function getPublicStoreSettings(): Promise<Pick<StoreSettings, 'siteTitle' | 'siteLogo' | 'emailHeaderLogo' | 'emailHeaderSlogan' | 'emailHeaderSubtitle' | 'emailFooterSupportEmail' | 'emailFooterSupportNumber' | 'contactEmail' | 'socialLinks'>>;
