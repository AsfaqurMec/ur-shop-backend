...
export declare function getMyPendingSubscriptions(req: Request, res: Response): Promise<Response>;
export declare function getMyDeliveredItems(req: Request, res: Response): Promise<Response>;
