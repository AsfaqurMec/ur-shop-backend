export declare const recentListValidator: import("express-validator").ValidationChain[];
...
export declare const lowStockValidator: import("express-validator").ValidationChain[];
