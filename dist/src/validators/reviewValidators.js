...
exports.listAllAdminReviewsValidator = exports.setHiddenValidator = exports.listAllPublicReviewsValidator = exports.listReviewsValidator = exports.updateAdminReviewValidator = exports.createAdminReviewValidator = exports.updateReviewValidator = exports.submitReviewValidator = exports.reviewIdParamValidator = exports.productIdParamValidator = void 0;
...
exports.updateAdminReviewValidator = [
    (0, express_validator_1.param)('reviewId').isInt({ min: 1 }).toInt(),
    (0, express_validator_1.body)('reviewer_name').optional().trim().isLength({ min: 1, max: 120 }).withMessage('Reviewer name is required'),
    (0, express_validator_1.body)('rating').optional().isInt({ min: 1, max: 5 }).toInt(),
    (0, express_validator_1.body)('title').optional().trim().isLength({ max: 255 }),
    (0, express_validator_1.body)('body').optional().trim(),
];
