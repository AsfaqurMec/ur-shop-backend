...
router.put('/:id/images/reorder', auth_1.auth, admin_1.admin, (0, validate_1.validate)(productValidators_1.productIdParamValidator), (0, asyncHandler_1.asyncHandler)(productController.reorderImages));
router.put('/:id/images/:imageId/primary', auth_1.auth, admin_1.admin, (0, validate_1.validate)(productValidators_1.imageIdParamValidator), (0, asyncHandler_1.asyncHandler)(productController.setPrimaryImage));
